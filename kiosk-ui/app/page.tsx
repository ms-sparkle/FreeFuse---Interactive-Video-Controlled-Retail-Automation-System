...
const Toast: React.FC<ToastProps> = ({ message, type, onDismiss }) => {
  ...
  const baseClasses =
    "fixed bottom-5 right-5 p-4 rounded-lg shadow-xl text-white font-semibold transition-transform transform translate-y-20";
  ...
  return <div className={`${baseClasses} ${typeClasses[type]} ${visibleClasses}`}>{message}</div>;
};
